        ...
        <div className="lp-hero-inner">
          <div className="lp-hero-content">
            ...
            <p className="lp-hero-sub">
              Traqzen connects IoT sensors on your vehicles to a unified command dashboard —
          ...
          <div className="lp-data-grid">
            <div className="lp-data-content">
              ...
              <p className="lp-section-sub" style={{ textAlign: 'left', margin: '0' }}>
                Hardware sensors transmit readings every few seconds. Traqzen ingests, stores and visualises this data with zero configuration.
              </p>
      ...
      <footer className="lp-footer">
        <div className="lp-container lp-footer-inner">
          <div className="lp-footer-brand">
            ...
            <p className="lp-footer-desc">IoT-Enabled Vehicle Management Solution for Real-Time Monitoring and Fleet Management. Built for small fleet operators across India.</p>
          </div>
